...
public class PiliPiliTitleView extends FrameLayout implements IControlComponent {
    ...
    private PiliPiliControlView.OnFullChangeListener mListener;

    public PiliPiliTitleView(@NonNull Context context) {
        super(context);
    }

    public PiliPiliTitleView(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public PiliPiliTitleView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    public void setListener(PiliPiliControlView.OnFullChangeListener mListener) {
